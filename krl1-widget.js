...
(function () {
  ...
  var SYSTEM_PROMPT =
    ...
    "- RAG (/rag-query) : Workers AI bge-small-en-v1.5 (embeddings Cloudflare native), cosine similarity inline dans le Worker, KB de 15 frameworks PM en code (chunks 300 mots, overlap 50), top-3 chunks injectés si intent=pm_workflow\n" +
